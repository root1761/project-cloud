 ...
 * @author Louyp
 * @version 1.0
 * @data 2020/01/08 16:28
 *//*

@Slf4j
public class ReactiveMemoryAuthenticationManager implements ReactiveAuthenticationManager {
    private TokenStore tokenStore;

    public ReactiveMemoryAuthenticationManager(TokenStore tokenStore){
